...
export class MnistLeNetNetwork {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        MnistLeNetNetworkFinalization.unregister(this);
        return ptr;
    }
    free() {
    ...
    get_probabilities(pixels) {
        ...
        try {
            ...
            const ret = wasm.mnistlenetnetwork_get_probabilities(this.__wbg_ptr, ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    get_weights() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.mnistlenetnetwork_get_weights(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    model_info() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.mnistlenetnetwork_model_info(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    constructor() {
        ...
        MnistLeNetNetworkFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    predict(pixels) {
        ...
        try {
            const ptr0 = passArrayF32ToWasm0(pixels, wasm.__wbindgen_malloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.mnistlenetnetwork_predict(this.__wbg_ptr, ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    test_all() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.mnistlenetnetwork_test_all(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./neural_wasm_mnist_lenet_bg.js": import0,
    };
}

const MnistLeNetNetworkFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_mnistlenetnetwork_free(ptr >>> 0, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('neural_wasm_mnist_lenet_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
