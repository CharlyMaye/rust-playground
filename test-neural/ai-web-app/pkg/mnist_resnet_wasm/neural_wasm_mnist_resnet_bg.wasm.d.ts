...
export const mnistresnetnetwork_get_activations: (a: number, b: number, c: number) => [number, number];
...
export const mnistresnetnetwork_get_cnn_activations: (a: number, b: number, c: number) => [number, number];
...
export const mnistresnetnetwork_new: () => [number, number, number];
export const mnistresnetnetwork_predict: (a: number, b: number, c: number) => [number, number];
export const mnistresnetnetwork_test_all: (a: number) => [number, number];
