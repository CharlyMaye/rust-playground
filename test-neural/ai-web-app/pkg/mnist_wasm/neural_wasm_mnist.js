/* @ts-self-types="./neural_wasm_mnist.d.ts" */
...
export class MnistNetwork {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        MnistNetworkFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_mnistnetwork_free(ptr, 0);
    }
    /**
    ...
    get_architecture() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.mnistnetwork_get_architecture(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    get_class_names() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.mnistnetwork_get_class_names(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    get_weights() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.mnistnetwork_get_weights(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    model_info() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.mnistnetwork_model_info(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     */
    constructor() {
        const ret = wasm.mnistnetwork_new();
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        MnistNetworkFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    test_all() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.mnistnetwork_test_all(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
if (Symbol.dispose) MnistNetwork.prototype[Symbol.dispose] = MnistNetwork.prototype.free;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./neural_wasm_mnist_bg.js": import0,
    };
}

const MnistNetworkFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_mnistnetwork_free(ptr >>> 0, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('neural_wasm_mnist_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
