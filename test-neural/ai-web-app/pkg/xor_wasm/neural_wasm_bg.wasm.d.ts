...
export const xor_predict: (a: number, b: number) => number;
export const xor_predict_raw: (a: number, b: number) => number;
export const xornetwork_confidence: (a: number, b: number, c: number) => number;
...
export const xornetwork_predict: (a: number, b: number, c: number) => number;
export const xornetwork_predict_raw: (a: number, b: number, c: number) => number;
