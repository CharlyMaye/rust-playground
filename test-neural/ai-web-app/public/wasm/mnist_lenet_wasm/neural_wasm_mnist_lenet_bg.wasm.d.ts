...
export const mnistlenetnetwork_get_cnn_summary: (a: number) => [number, number];
...
export const mnistlenetnetwork_new: () => [number, number, number];
export const mnistlenetnetwork_predict: (a: number, b: number, c: number) => [number, number];
export const mnistlenetnetwork_test_all: (a: number) => [number, number];
