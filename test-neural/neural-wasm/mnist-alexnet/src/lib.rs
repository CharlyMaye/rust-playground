        ...
        let summary = ArchitectureSummary {
            ...
            layers: vec![
                LayerSummary {
                    ...
                    config: "1→64, 3x3, pad=1".to_string(),
                },
                LayerSummary {
                    name: "BatchNorm2D".to_string(),
                    config: "64".to_string(),
                },
                LayerSummary {
                    name: "ReLU".to_string(),
                ...
                LayerSummary {
                    name: "Conv2D".to_string(),
                    config: "64→128, 3x3, pad=1".to_string(),
                },
                LayerSummary {
                    name: "BatchNorm2D".to_string(),
                    config: "128".to_string(),
                },
                LayerSummary {
                    name: "ReLU".to_string(),
                    config: "".to_string(),
                ...
                LayerSummary {
                    name: "Conv2D".to_string(),
                    config: "128→256, 3x3, pad=1".to_string(),
                },
                LayerSummary {
                    name: "BatchNorm2D".to_string(),
                    config: "256".to_string(),
                },
                LayerSummary {
                    name: "ReLU".to_string(),
                    config: "".to_string(),
                ...
                LayerSummary {
                    name: "Conv2D".to_string(),
                    config: "256→256, 3x3, pad=1".to_string(),
                },
                LayerSummary {
                    name: "BatchNorm2D".to_string(),
                    config: "256".to_string(),
