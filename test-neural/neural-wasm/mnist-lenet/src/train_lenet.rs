//! LeNet-5 CNN: End-to-End Training with Autograd
//!
//! Trains a LeNet-5 CNN end-to-end using cma_autograd (LeCun et al., 1998).
//!
//! Architecture:
//! - C1: Conv(1→6, 5×5, p=2) → ReLU → AvgPool(2,2)        28×28→14×14
//! - C3: Conv(6→16, 5×5) → ReLU → AvgPool(2,2)             10×10→5×5
//! - C5: Conv(16→120, 5×5) → ReLU                           1×1×120
//! - Flatten → Linear(120→10)
...
fn main() -> Result<(), Box<dyn Error>> {
    println!("╔══════════════════════════════════════════════════════════════╗");
    println!("║     LeNet-5: End-to-End CNN Training with Autograd           ║");
    println!("╚══════════════════════════════════════════════════════════════╝\n");
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // 2. BUILD LeNet-5 CNN (autograd)
    // ═══════════════════════════════════════════════════════════════════════
    println!("🔧 Building LeNet-5 CNN (autograd)...\n");
    ...
    println!("\n   LeNet-5: {}/{} correct ({:.2}%)", correct, total, acc * 100.0);
