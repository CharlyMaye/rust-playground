//! VGG-Tiny: End-to-End CNN Training with Autograd
//!
//! Trains a VGG-style CNN end-to-end (Simonyan & Zisserman, 2014).
//!
//! Architecture:
//! - Block 1: Conv(1→32, 3×3, p=1) → ReLU → Conv(32→32, 3×3, p=1) → ReLU → MaxPool(2,2)  28→14
//! - Block 2: Conv(32→64, 3×3, p=1) → ReLU → Conv(64→64, 3×3, p=1) → ReLU → MaxPool(2,2) 14→7
//! - Flatten → Linear(3136→10)
...
fn main() -> Result<(), Box<dyn Error>> {
    println!("╔══════════════════════════════════════════════════════════════╗");
    println!("║    VGG-Tiny: End-to-End CNN Training with Autograd           ║");
    println!("╚══════════════════════════════════════════════════════════════╝\n");
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // 2. BUILD VGG-Tiny CNN (autograd)
    // ═══════════════════════════════════════════════════════════════════════
    println!("🔧 Building VGG-Tiny CNN (autograd)...\n");

    let mut model = CnnBuilder::vgg_mnist(10);
    ...
    println!("\n   VGG-Tiny: {}/{} correct ({:.2}%)", correct, total, acc * 100.0);
